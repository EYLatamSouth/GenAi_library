...
def send_message(perfil_sistema: str,
...
chat_display = scrolledtext.ScrolledText(window,
                                         width=80,
                                         height=20,
                                         font=("Helvetica", 12),
                                         bg="#333333",  # "#ffffff",
                                         fg="#ffffff",  # "#333333",
                                         relief=tk.SUNKEN)
chat_display.grid(row=0, column=0, padx=15,
                  pady=10, columnspan=4, sticky="nsew")
...
microphone_button = tk.Button(window,
